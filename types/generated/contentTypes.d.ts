...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::blog.blog'> &
      Schema.Attribute.Private;
    Primary_Heading: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiGeneralGeneral extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    Small_Logo: Schema.Attribute.Media<'images' | 'files'>;
    SMTP: Schema.Attribute.Component<'settings.smtp', false>;
...
export interface ApiResponsePageResponsePage
  ...
  info: {
    ...
    pluralName: 'response-pages';
    singularName: 'response-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::response-page.response-page'
    > &
      Schema.Attribute.Private;
    Message: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    Status_Code: Schema.Attribute.Enumeration<['SUCCESS', 'NOT_FOUND']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Author: Schema.Attribute.Component<'common.author', false>;
    Content: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
...
export interface ApiWidgetWidget extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    CTA: Schema.Attribute.Component<'widget.call-to-action', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::widget.widget'
    > &
      Schema.Attribute.Private;
    Moments: Schema.Attribute.Component<'widget.moments', false>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
