                ...
                <head>
                  ...
                  <style>
                    * { margin: 0; padding: 0; box-sizing: border-box; }
                    ...
                    .company-name { color: #1a73e8; font-size: 24px; font-weight: 700; margin-bottom: 10px; }
                    h2 { color: #1a73e8; margin-bottom: 25px; font-size: 24px; font-weight: 600; text-align: center; }
                    h3 { color: #34495e; margin-bottom: 15px; font-size: 18px; font-weight: 500; border-bottom: 2px solid #e9ecef; padding-bottom: 8px; }
                ...
                <head>
                  ...
                  <style>
                    * { margin: 0; padding: 0; box-sizing: border-box; }
                    ...
                    .company-name { font-size: 20px; font-weight: bold; color: #1a73e8; }
                    h2 { color: #1a73e8; margin-bottom: 25px; font-size: 24px; font-weight: 600; }
                    .message p { margin-bottom: 15px; }
                    .footer { margin-top: 25px; padding-top: 20px; border-top: 1px solid #e9ecef; color: #7f8c8d; }
                  </style>
                </head>
                <body>
                  <div class="container">
